	      ...
	      <div class="form-wrap">
			...
			<form class="form" action="<?= PATH ?>register" method="POST">
				...
				<div class="form_item">
					...
					<input type="text" name="name_reg" id="name_reg" value="<?php if(isset($_SESSION['reg']['reg_name'])) echo $_SESSION['reg']['reg_name'];?>">
				</div>
				<div class="form_item">
					<label for="email_reg"> Email:<span class="check-icon"></span></label>
					<input class="access" type="text" data-field="email" name="email_reg" id="email_reg" value="<?php if(isset($_SESSION['reg']['reg_email'])) echo $_SESSION['reg']['reg_email']?>">
				</div>
				<div class="form_item">
					<label for="login_reg">Логин:<span class="check-icon"></span></label>
					<input class="access" type="text" data-field="login" name="login_reg" id="login_reg" value="<?php if(isset($_SESSION['reg']['reg_login'])) echo$_SESSION['reg']['reg_login']?>">
				</div>
				<div class="form_item">
